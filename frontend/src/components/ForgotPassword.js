...
function ForgotPassword() {
  ...
  async function handleForgotpassword(e) {
    ...
    try {
      const response = await axios({
        method: "post",
        url: "http://localhost:8000/api/auth/forgotpassword",
        data: { email },
      });
  ...
  return (
    <>
      <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 m-4 form-container forgetPass">
